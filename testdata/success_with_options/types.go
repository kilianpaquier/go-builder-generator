...
//go:generate go tool go-builder-generator generate -f types.go -s Options,Empty,GenericOptions -d builders --validate-func Validate --return-copy -p Set --no-notice
