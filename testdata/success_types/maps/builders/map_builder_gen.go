...
func (b *MapBuilder) Build() *testdata.Map {
	result := b.build
	return &result
}
...
func (b *MapBuilder) MapFieldAlias(mapFieldAlias map[testdata.Int64Alias]testdata.FuncAlias) *MapBuilder {
...
func (b *MapBuilder) MapFieldPtrAlias(mapFieldPtrAlias map[*testdata.Int64Alias]*testdata.FuncAlias) *MapBuilder {
