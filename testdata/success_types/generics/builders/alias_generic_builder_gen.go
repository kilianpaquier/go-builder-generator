...
type AliasGenericBuilder[t any, GV testdata.GenericValue] struct {
	build testdata.AliasGeneric[t, GV]
}

// NewAliasGenericBuilder creates a new AliasGenericBuilder.
func NewAliasGenericBuilder[t any, GV testdata.GenericValue]() *AliasGenericBuilder[t, GV] {
...
func (b *AliasGenericBuilder[t, GV]) Build() *testdata.AliasGeneric[t, GV] {
	result := b.build
	return &result
}
