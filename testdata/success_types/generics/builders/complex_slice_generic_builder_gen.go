...
type ComplexSliceGenericBuilder[S ~[]E, E testdata.Struct] struct {
	build testdata.ComplexSliceGeneric[S, E]
}

// NewComplexSliceGenericBuilder creates a new ComplexSliceGenericBuilder.
func NewComplexSliceGenericBuilder[S ~[]E, E testdata.Struct]() *ComplexSliceGenericBuilder[S, E] {
...
func (b *ComplexSliceGenericBuilder[S, E]) Build() *testdata.ComplexSliceGeneric[S, E] {
	result := b.build
	return &result
}
