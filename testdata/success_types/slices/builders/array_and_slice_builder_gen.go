...
func (b *ArrayAndSliceBuilder) Build() *testdata.ArrayAndSlice {
	result := b.build
	return &result
}
...
func (b *ArrayAndSliceBuilder) ArrayFieldAlias(arrayFieldAlias [10]testdata.Int64Alias) *ArrayAndSliceBuilder {
	b.build.ArrayFieldAlias = arrayFieldAlias
	return b
}

// ArrayFieldPtrAlias sets ArrayAndSlice's ArrayFieldPtrAlias.
func (b *ArrayAndSliceBuilder) ArrayFieldPtrAlias(arrayFieldPtrAlias [10]*testdata.Int64Alias) *ArrayAndSliceBuilder {
...
func (b *ArrayAndSliceBuilder) SliceFieldAlias(sliceFieldAlias []testdata.Int64Alias) *ArrayAndSliceBuilder {
	b.build.SliceFieldAlias = sliceFieldAlias
	return b
}

// SliceFieldAliasChan sets ArrayAndSlice's SliceFieldAliasChan.
func (b *ArrayAndSliceBuilder) SliceFieldAliasChan(sliceFieldAliasChan []chan<- testdata.Int64Alias) *ArrayAndSliceBuilder {
	b.build.SliceFieldAliasChan = sliceFieldAliasChan
	return b
}

// SliceFieldPtrAlias sets ArrayAndSlice's SliceFieldPtrAlias.
func (b *ArrayAndSliceBuilder) SliceFieldPtrAlias(sliceFieldPtrAlias []*testdata.Int64Alias) *ArrayAndSliceBuilder {
