...
func (b *ChanBuilder) Build() *testdata.Chan {
	result := b.build
	return &result
}
...
func (b *ChanBuilder) ChanFieldAlias(chanFieldAlias chan testdata.Int64Alias) *ChanBuilder {
	b.build.ChanFieldAlias = chanFieldAlias
	return b
}

// ChanFieldPtrAlias sets Chan's ChanFieldPtrAlias.
func (b *ChanBuilder) ChanFieldPtrAlias(chanFieldPtrAlias chan *testdata.Int64Alias) *ChanBuilder {
	b.build.ChanFieldPtrAlias = &chanFieldPtrAlias
	return b
}

// ChanFieldSliceAlias sets Chan's ChanFieldSliceAlias.
func (b *ChanBuilder) ChanFieldSliceAlias(chanFieldSliceAlias chan []testdata.FuncAlias) *ChanBuilder {
	b.build.ChanFieldSliceAlias = chanFieldSliceAlias
	return b
}

// ChanFieldSliceFunc sets Chan's ChanFieldSliceFunc.
func (b *ChanBuilder) ChanFieldSliceFunc(chanFieldSliceFunc chan []func(testdata.Int64Alias) (err error)) *ChanBuilder {
...
func (b *ChanBuilder) RChanFieldAlias(rchanFieldAlias <-chan testdata.Int64Alias) *ChanBuilder {
	b.build.RChanFieldAlias = rchanFieldAlias
	return b
}

// RChanFieldPtrAlias sets Chan's RChanFieldPtrAlias.
func (b *ChanBuilder) RChanFieldPtrAlias(rchanFieldPtrAlias <-chan *testdata.Int64Alias) *ChanBuilder {
...
func (b *ChanBuilder) SChanFieldAlias(schanFieldAlias chan<- testdata.Int64Alias) *ChanBuilder {
	b.build.SChanFieldAlias = schanFieldAlias
	return b
}

// SChanFieldPtrAlias sets Chan's SChanFieldPtrAlias.
func (b *ChanBuilder) SChanFieldPtrAlias(schanFieldPtrAlias chan<- *testdata.Int64Alias) *ChanBuilder {
